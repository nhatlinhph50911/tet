...
<body>
    <div class="container">
        ...
        <article>
            ...
            <button class="create"><a href="?action=createPhone">Thêm hàng hóa</a></button>
            <table border="1px solid">
                ...
                foreach ($phones as $phone) { ?>
                    <tr>
                        <td> <?php echo $phone['ma_hh']; ?> </td>
                        <td> <?php echo $phone['name']; ?> </td>
                        <td> <img width="250px" height="200px" src="<?php echo $phone['image']; ?>" alt=""> </td>
                        <td> <?php echo $phone['price']; ?> </td>
                        <td> <?php echo $phone['ngay_nhap']; ?> </td>
                        <td> <?php echo $phone['mo_ta']; ?> </td>
                        <td> <?php echo $phone['ma_loai']; ?> </td>
                        <td>
                            <button class="DvE">
                                <a href="?action=deletePhone&id=<?php echo $phone['ma_hh']; ?>">delete</a>
                            </button>
                        </td>
                        <td>
                            <button class="DvE">
                                <a class="deleteEdit" href="?action=editPhone&id=<?php echo $phone['ma_hh']; ?>">edit</a>
                            </button>
                        </td>
