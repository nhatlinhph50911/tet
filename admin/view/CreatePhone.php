...
<body>
    <div class="container">
        ...
        <article>
            <h1>create phone</h1>
            <form action="?action=store-phone" method="POST" enctype="multipart/form-data">
                <!-- id : <input type="number" name="ma_hh"><br> -->
                name: <input type="text" name='name'><br>
                giá bán: <input type="number" name='price'><br>
                ngày nhập: <input type="date" name='ngay_nhap'><br>
                mô tả: <input type="text" name='mo_ta'><br>
                mã loại <input type="number" name='ma_loai'><br>
                anh:
                <input type="file" name='anh'>
                <input type="submit" name='add_phone' value="Them">
            </form>
        </article>
