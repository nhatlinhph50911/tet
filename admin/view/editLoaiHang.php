...
<body>
    <div class="container">
        ...
        <article>
            ...
            <form action="?action=store-EditloaiHang" method="POST" enctype="multipart/form-data">
                mã loại: <input type="number" value="<?php echo $loai['ma_loai'] ?>" name='ma_loai'><br>
                tên loại: <input type="text" value="<?php echo $loai['ten_loai'] ?> name='name'><br>
                <input type=" submit" name='update-Loai' value="Them">
            </form>
        </article>
